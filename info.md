...
_A Home Assistant custom integration for Reolink Device Discovery_

{% if not installed %}
## Installation

1. Click install.
1. In the HA UI go to "Configuration" -> "Integrations" click "+" and search for "ReoLink Discovery".
